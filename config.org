...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package org-ql :defer t :ensure t)
...
** company
   #+BEGIN_SRC emacs-lisp :tangle yes
     ...
     (use-package company-tabnine :defer t :ensure t
       :config (add-to-list 'company-backends 'company-tabnine))
   #+END_SRC
** lisp
   #+BEGIN_SRC emacs-lisp :tangle yes
     (use-package parinfer :defer t :ensure t)
     ;; paredit!
...
** haskell
   #+begin_src emacs-lisp :tangle yes
     ...
     (use-package lsp-haskell :defer t :ensure t)
   #+end_src
** go
   #+BEGIN_SRC emacs-lisp :tangle yes
...
** shell
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
	...
	(shell-command-to-string
     ...
     (use-package vterm :defer t :ensure t)
   #+END_SRC
** nix
 #+begin_SRC emacs-lisp :tangle yes
...
** posframe
   #+begin_src emacs-lisp :tangle yes
     (use-package flycheck-posframe :defer t :ensure t
       :hook (flycheck-posframe-mode . flycheck-mode))
     (use-package company-posframe :defer t :ensure t
       :hook (company-posframe-mode . company-mode))
   #+end_src
** Which key
 #+BEGIN_SRC emacs-lisp :tangle yes
