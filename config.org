...
** docker
   #+begin_src emacs-lisp :tangle yes
	 (use-package docker)
	 (straight-use-package '(dockerfile-mode :type git :repo "https://github.com/fredeeb/dockerfile-mode"))
...
* hotkeys
  #+begin_src emacs-lisp :tangle yes
	...
	(evil-leader/set-key
	  ...
	  "f d" 'dired-jump
	  "f j" 'find-journal
	  "f n" '(lambda () (interactive) (find-file (concat (vc-root-dir) "notes.org")))
