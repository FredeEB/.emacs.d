...
** c++
   #+BEGIN_SRC emacs-lisp :tangle yes
     (use-package ccls
       :custom
       (ccls-executable (expand-file-name "./ccls/build/ccls")))
...
* hotkeys
  ...
  (evil-leader/set-key
    ...
    "g r" 'helm-swoop-from-evil-search
    ...
    "f j" 'find-journal
    "f q" '(lambda () (interactive) (let ((b (buffer-name))) (dired-jump) (kill-buffer b)))
